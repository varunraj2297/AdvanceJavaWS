...
/*create or replace procedure p_selectNonselectEmp(depno in number,studetails out sys_refcursor,cnt out number)
as
begin
...
*/
public class CsSelectAndNonSelectOnEmpTableUsingProcedure {
private static final String CALL_QUERY="{ CALL P_SELECTNONSELECTEMP(?,?,?) }";
