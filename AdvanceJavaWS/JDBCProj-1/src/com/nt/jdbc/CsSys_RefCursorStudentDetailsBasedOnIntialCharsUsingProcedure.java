...
/*create or replace procedure p_studetailsusinginitchars(initchars in varchar,studetails out sys_refcursor)
as
begin
...
public class CsSys_RefCursorStudentDetailsBasedOnIntialCharsUsingProcedure {
private static final String CALL_QUERY="{  CALL P_STUDETAILSUSINGINITCHARS(?,?) }";
